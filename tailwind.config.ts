  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        ubc: {
          DEFAULT: "hsl(var(--ubc))",
          light: "hsl(var(--ubc-light))",
        },
        carton: {
          DEFAULT: "hsl(var(--carton))",
          light: "hsl(var(--carton-light))",
        },
        "flex-plastic": {
          DEFAULT: "hsl(var(--flex-plastic))",
          light: "hsl(var(--flex-plastic-light))",
        },
        pet: {
          DEFAULT: "hsl(var(--pet))",
